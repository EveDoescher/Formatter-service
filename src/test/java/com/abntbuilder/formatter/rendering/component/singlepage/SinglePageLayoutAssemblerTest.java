...
class SinglePageLayoutAssemblerTest {
    ...
    private static SinglePageContent contentWith(Map<String, com.abntbuilder.formatter.document.component.singlepage.ContentValue> slots) {
        return new SinglePageContent("testComponent", slots);
    }

    private static SinglePageComponentRule ruleWith(
            Map<String, com.abntbuilder.formatter.profile.model.component.singlepage.SlotRule> slots,
