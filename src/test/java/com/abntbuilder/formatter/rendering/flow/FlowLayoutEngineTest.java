        ...
        List<BodySection> sections = List.of(
                new BodySection("intro", 1, Optional.empty(),
                        List.of(new BodyParagraph(List.of(
                                new com.abntbuilder.formatter.document.component.bodycontent.BodyText(
                                        "Parágrafo.", com.abntbuilder.formatter.document.component.bodycontent.InlineFormatting.none())
                        ))))
        );
