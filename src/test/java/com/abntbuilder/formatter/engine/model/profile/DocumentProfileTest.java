...
class DocumentProfileTest {
    ...
    private static SinglePageComponentRule validCoverComponentRule(String componentId) {
        ...
        com.abntbuilder.formatter.engine.model.profile.layout.singlepage.SinglePageLayoutRule layoutRule =
                new com.abntbuilder.formatter.engine.model.profile.layout.singlepage.SinglePageLayoutRule(
