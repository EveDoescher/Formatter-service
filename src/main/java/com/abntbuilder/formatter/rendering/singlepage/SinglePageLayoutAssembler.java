...
import com.abntbuilder.formatter.rendering.singlepage.ResolvedLayoutGap;
...
import com.abntbuilder.formatter.rendering.text.MeasuredText;
...
public final class SinglePageLayoutAssembler {
    ...
    private static List<String> resolveValues(
        ...
        return switch (value) {
            ...
            case com.abntbuilder.formatter.engine.model.content.singlepage.TableValue ignored ->
            ...
            case com.abntbuilder.formatter.engine.model.content.singlepage.EntryListValue ignored ->
                throw new com.abntbuilder.formatter.shared.exception.InvalidSinglePageContentException(
