...
import com.abntbuilder.formatter.engine.model.content.bodycontent.BodyQuoteText;
    ...
    BodyInline toDomain(CitationFormattingRule citationFormatting) {
        ...
        return switch (type) {
            ...
            case ABBREVIATION -> {
                ...
                yield new com.abntbuilder.formatter.engine.model.content.bodycontent.BodyAbbreviation(text, expansion);
            }
            case FOOTNOTE -> {
                if (content == null || content.isEmpty()) {
                    throw new IllegalArgumentException("FOOTNOTE.content must not be empty.");
                }
                yield new com.abntbuilder.formatter.engine.model.content.bodycontent.BodyFootnote(
