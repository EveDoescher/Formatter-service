...
- `body-content-tables.json`: valid text body with table blocks and explicit table continuation.
...
- `body-content-table-row-mismatch-invalid.json`: invalid table row with a cell count different from the column count.
...
renders table caption, table grid and source as one display object;
